...
def build_presupuesto(fields, field_values, total):
    ...
    # Fallbacks si exact no encuentra
    ...
    kpis = [
        ...
        {"label": "CDP ejecutado",           "value": f"${cdp:,.0f}",          "sub": f"{pct_cdp}% comprometido",  "icon": "check"},
    ...
    sections.append({
        ...
        "bars": [
            {"label": "CDP ejecutado",      "value": pct_cdp,   "pct": pct_cdp,   "color": "#1B3A6B"},
